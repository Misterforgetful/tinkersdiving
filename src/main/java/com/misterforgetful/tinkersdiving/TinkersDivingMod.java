...
import com.misterforgetful.tinkersdiving.modifiers.abilities.armor.DivingHelmetModifier;
import com.misterforgetful.tinkersdiving.modifiers.abilities.armor.DivingBootsModifier;

@Mod(TinkersDivingMod.MODID)
public class TinkersDivingMod {
    public static final String MODID = "tinkersdiving";
    public static final String VERSION = "1.1.12.7";
    ...
    public TinkersDivingMod() {
        ...
        TinkersDivingModifiers.register(FMLJavaModLoadingContext.get().getModEventBus()); 
        DivingEvents.init();
        ModLoadingContext.get().registerConfig(ModConfig.Type.COMMON, TinkersDivingConfig.COMMON_SPEC);
    }
