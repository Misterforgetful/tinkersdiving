package com.misterforgetful.tinkersdiving.config;

import net.minecraftforge.common.ForgeConfigSpec;
//I have no clue how this works, I just asked copilot in this case because it'd be kind for users to have.
